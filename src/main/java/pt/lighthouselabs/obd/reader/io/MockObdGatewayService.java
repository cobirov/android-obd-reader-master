...
//public MainActivity bbb= MainActivity;
      ...
      while (!Thread.currentThread().isInterrupted()) {
          ...
          try {
            ...
            if (job.getState().equals(ObdCommandJobState.NEW)) {
              ...
              engineRpmCommand.run(new ByteArrayInputStream("41 00 00 00>41 00 00 00>41 00 00 00>".getBytes()), new ByteArrayOutputStream());
              MainActivity.posit2=engineRpmCommand.getRPM();//job.getCommand().
            } else {
